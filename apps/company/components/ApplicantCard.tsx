...
interface ApplicantCardProps {
    applicant: Applicant;
    questions: NonNullable<Job['questions']>;
    jobSkills: string[];
                    ...
                    <div className="flex-1">
                        <div className="flex justify-between items-start gap-4">
                            <div>
                                ...
                                <p className="text-sm font-medium text-primary mb-0.5">{applicant.jobTitle}</p>
                            ...
                            <CollapsibleSection title="Recruiter's questions">
                                <div className="space-y-3">
                                    {questions.map((q, index) => (
                                        <div key={index}>
                                            <p className="font-semibold text-gray-800 text-sm">{index + 1}. {q.question}</p>
                                            <p className="pl-4 mt-1 text-gray-600 border-l-2 ml-1 text-sm">
                                                {typeof applicant.answers[index] === 'boolean'
                                                    ? (applicant.answers[index] ? 'Yes' : 'No')
                                                    : (applicant.answers[index] || "Not answered")}
                                            </p>
                                        </div>
                                    ))}
                                </div>
