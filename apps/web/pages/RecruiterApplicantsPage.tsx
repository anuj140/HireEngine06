...
import { useToast } from '../../company/hooks/useToast';
                        ...
                        {filteredApplicants.map(applicant => {
                            ...
                            return (
                                <ApplicantCard 
                                    ...
                                    applicant={applicant} 
                                    // DO: Add comment above each fix.
                                    // FIX: Property 'recruiterQuestions' does not exist on type 'Job'. Using 'questions' and mapping to an array of question strings.
