...
export const ShieldExclamationIcon: React.FC<IconProps> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M12 9v3.75m0 3.75h.008v.008H12v-.008zM12 2.25c.991 0 1.943.149 2.857.424l.468.141.22.427a11.95 11.95 0 013.82 5.92c.325.96.48 1.986.48 3.031 0 5.592-3.824 10.29-9 11.622-5.176-1.332-9-6.03-9-11.622 0-1.045.155-2.071.48-3.031a11.95 11.95 0 013.82-5.92l.22-.427.468-.141A11.952 11.952 0 0112 2.25z" />
  </svg>
);
...
export const BoldIcon: React.FC<IconProps> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" fill="currentColor" {...props}>
    <path d="M6 2.75A.75.75 0 016.75 2h4.5a2.75 2.75 0 012.75 2.75v.5A2.75 2.75 0 0111.25 8h-4.5A.75.75 0 016 7.25V2.75zm1.5.75v3h3a1.25 1.25 0 100-2.5h-3zm-1.5 6A.75.75 0 016.75 8h5.5a2.75 2.75 0 012.75 2.75v.5A2.75 2.75 0 0112.25 14h-5.5a.75.75 0 01-.75-.75v-3.5zm1.5.75v2h4a1.25 1.25 0 100-2.5h-4z" />
  </svg>
);

export const ItalicIcon: React.FC<IconProps> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" {...props}>
    <path d="M7.75 3a.75.75 0 000 1.5h1.22l-2.316 8.5h-1.404a.75.75 0 000 1.5h4.5a.75.75 0 000-1.5h-1.22l2.316-8.5h1.404a.75.75 0 000-1.5h-4.5z" />
  </svg>
);
...
export const WindowIcon: React.FC<IconProps> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M2.25 7.125A2.25 2.25 0 014.5 4.875h15A2.25 2.25 0 0121.75 7.125v10.5A2.25 2.25 0 0119.5 19.875h-15A2.25 2.25 0 012.25 17.625v-10.5zM21.75 7.125v.001M2.25 7.125v.001" />
  </svg>
);
