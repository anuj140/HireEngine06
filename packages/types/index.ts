...
export interface UserProfile {
    ...
    skills: string[];
    // DO: Add comment above each fix.
    // FIX: Updated itSkills to use ITSkill interface.
    itSkills?: ITSkill[]; 
    ...
    // DO: Add comment above each fix.
    // FIX: Added optional recruiterActionsCount property.
    recruiterActionsCount?: number;
}
...
export interface User {
    ...
    updatedAt?: string;
    // DO: Add comment above each fix.
    // FIX: Add 'status' property to the User interface to fix type errors in admin panel components that expect this field.
...
export interface Application {
    ...
    jobTitle: string;
    companyName: string;
    status: 'Applied' | 'Viewed' | 'Shortlisted' | 'Rejected' | 'Interview Scheduled' | 'Hired';
    appliedDate: string;
}
...
export interface UserActivityContextType {
    ...
    // DO: Add comment above each fix.
    // FIX: Add 'withdrawApplication' to the context type for withdrawing applications.
